...
export default function ViewProfile() {
  ...
  const [badgeBal, setBadgeBal] = useState("");
  const [info0, setInfo0] = useState("");
  const [info1, setInfo1] = useState("");
  const [info2, setInfo2] = useState("");
  const [info3, setInfo3] = useState("");
  const [info4, setInfo4] = useState("");
  const [info41, setInfo41] = useState("");
  const [info42, setInfo42] = useState("");
  const [info43, setInfo43] = useState("");
  ...
  console.log("all information", info41, info42, info43);
  ...
  const profileOneRead = useContractRead({
    ...
    args: address,
    onSuccess(data) {
      console.log("good data boss", data);
      setInfo0(data[0]);
      setInfo1(data[1]);
      setInfo2(data[2]);
      setInfo3(data[3]);
          ...
          <div class="bg-white p-3 border-t-4 border-green-400">
            ...
            <ul class="bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
              <li class="flex items-center py-3">
                <span>Status</span>
                <span class="ml-auto">
                  <span class="bg-green-500 py-1 px-2 rounded text-black text-sm">
                    {info43}
                  </span>
                </span>
              </li>
              <li class="flex items-center py-3">
                ...
                <span class="ml-auto">Nov 07, 2011</span>
              </li>
            </ul>
          </div>
          <div class="my-4"></div>
