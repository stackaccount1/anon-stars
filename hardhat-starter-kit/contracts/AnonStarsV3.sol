...
contract AnonStars {
    ...
    function viewProfileStrings(address _whoseThatProfile)
        ...
        returns (
            ...
            string memory phone,
            string memory jobSeekingStatus
        )
    {
        uint256 idtoreturn = idToOwner[_whoseThatProfile];
        Profile memory myProfile = profiles[idtoreturn];
    ...
    function returnAddressFromIdNumber(uint256 _id) public view returns (address) {
        return profileToOwner[_id];
    }
